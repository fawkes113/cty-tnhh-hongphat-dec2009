...
{
	#region ORDERS_Insert Wrapper
    /// <summary>
    /// This class is a wrapper for the ORDERS_Insert stored procedure.
    /// </summary>
    public class ORDERS_Insert
    {
		...
		#region Constructors
		public ORDERS_Insert()
		{
		}
		
		public ORDERS_Insert(string connectionString)
		{
		...
		/// <summary>
		/// The connection string to use when executing the ORDERS_Insert stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the return value from the ORDERS_Insert stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the number of rows changed, inserted, or deleted by execution of the ORDERS_Insert stored procedure.
		/// </summary>
		...
		/// <summary>
		/// This method calls the ORDERS_Insert stored procedure.
		/// </summary>
		public virtual void Execute()
		{
			...
			try
			{
				...
				if (_orderIdSet == true)
				{
				prmOrderId.Direction = ParameterDirection.InputOutput;
				}
				else
				{
				...
				if (prmOrderId != null && prmOrderId.Value != null)
				{
					if (prmOrderId.Value is SqlInt32)
					{
						this.OrderId = (SqlInt32)prmOrderId.Value;
					}
					else
					{
						if (prmOrderId.Value != DBNull.Value)
						{
							this.OrderId = new SqlInt32((int)prmOrderId.Value);
						}
						else
						{
							this.OrderId = SqlInt32.Null;
						}
					}
				}
				else
		...
		public static void Execute(
				...
				SqlInt32 status,
				SqlString note,
				ref SqlInt32 orderId
				#endregion
		    )
		{
			ORDERS_Insert oRDERS_Insert = new ORDERS_Insert();
			
			#region Assign Property Values
			oRDERS_Insert.ConnectionString = connectionString;
			oRDERS_Insert.OrderId = orderId;
			oRDERS_Insert.OrderKind = orderKind;
			oRDERS_Insert.CustomerId = customerId;
			oRDERS_Insert.CreatedBy = createdBy;
			oRDERS_Insert.CreatedDate = createdDate;
			oRDERS_Insert.ModifiedBy = modifiedBy;
			oRDERS_Insert.ModifiedDate = modifiedDate;
			oRDERS_Insert.Total = total;
			oRDERS_Insert.Pay = pay;
			oRDERS_Insert.Status = status;
			oRDERS_Insert.Note = note;
			#endregion
			
			oRDERS_Insert.Execute();
			
			#region Get Property Values
			orderId = oRDERS_Insert.OrderId;
			#endregion
		}
		#endregion
	}
