...
{
	#region PARTNERS_Insert Wrapper
    /// <summary>
    /// This class is a wrapper for the PARTNERS_Insert stored procedure.
    /// </summary>
    public class PARTNERS_Insert
    {
		...
		#region Constructors
		public PARTNERS_Insert()
		{
		}
		
		public PARTNERS_Insert(string connectionString)
		{
		...
		/// <summary>
		/// The connection string to use when executing the PARTNERS_Insert stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the return value from the PARTNERS_Insert stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the number of rows changed, inserted, or deleted by execution of the PARTNERS_Insert stored procedure.
		/// </summary>
		...
		/// <summary>
		/// This method calls the PARTNERS_Insert stored procedure.
		/// </summary>
		public virtual void Execute()
		{
			...
			{
				cmd.Connection = cn;
				cmd.CommandText = "[dbo].[PARTNERS_Insert]";
				...
				if (_partnerIdSet == true)
				{
				prmPartnerId.Direction = ParameterDirection.InputOutput;
				}
				else
				{
					prmPartnerId.Direction = ParameterDirection.Output;
				}
				...
				if (prmPartnerId != null && prmPartnerId.Value != null)
				{
					if (prmPartnerId.Value is SqlInt32)
					{
						this.PartnerId = (SqlInt32)prmPartnerId.Value;
					}
					else
					{
						if (prmPartnerId.Value != DBNull.Value)
						{
							this.PartnerId = new SqlInt32((int)prmPartnerId.Value);
						}
						else
						{
							this.PartnerId = SqlInt32.Null;
						}
					}
				}
				else
		...
		public static void Execute(
				...
				ref SqlInt32 partnerId
				#endregion
		    )
		{
			PARTNERS_Insert pARTNERS_Insert = new PARTNERS_Insert();
			
			#region Assign Property Values
			pARTNERS_Insert.ConnectionString = connectionString;
			pARTNERS_Insert.PartnerId = partnerId;
			pARTNERS_Insert.PartnerName = partnerName;
			pARTNERS_Insert.Address = address;
			pARTNERS_Insert.PhoneNumber = phoneNumber;
			#endregion
			
			pARTNERS_Insert.Execute();
			
			#region Get Property Values
			partnerId = pARTNERS_Insert.PartnerId;
			#endregion
		}
		#endregion
	}
