...
{
	#region ORDER_DETAILS_Insert Wrapper
    /// <summary>
    /// This class is a wrapper for the ORDER_DETAILS_Insert stored procedure.
    /// </summary>
    public class ORDER_DETAILS_Insert
    {
		...
		#region Constructors
		public ORDER_DETAILS_Insert()
		{
		}
		
		public ORDER_DETAILS_Insert(string connectionString)
		{
		...
		/// <summary>
		/// The connection string to use when executing the ORDER_DETAILS_Insert stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the return value from the ORDER_DETAILS_Insert stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the number of rows changed, inserted, or deleted by execution of the ORDER_DETAILS_Insert stored procedure.
		/// </summary>
		...
		/// <summary>
		/// This method calls the ORDER_DETAILS_Insert stored procedure.
		/// </summary>
		public virtual void Execute()
		{
			...
			{
				cmd.Connection = cn;
				cmd.CommandText = "[dbo].[ORDER_DETAILS_Insert]";
				...
				if (_orderDetailIdSet == true)
				{
				prmOrderDetailId.Direction = ParameterDirection.InputOutput;
				}
				else
				{
					prmOrderDetailId.Direction = ParameterDirection.Output;
				}
				...
				if (prmOrderDetailId != null && prmOrderDetailId.Value != null)
				{
					if (prmOrderDetailId.Value is SqlInt32)
					{
						this.OrderDetailId = (SqlInt32)prmOrderDetailId.Value;
					}
					else
					{
						if (prmOrderDetailId.Value != DBNull.Value)
						{
							this.OrderDetailId = new SqlInt32((int)prmOrderDetailId.Value);
						}
						else
						{
							this.OrderDetailId = SqlInt32.Null;
						}
					}
				}
				else
		...
		public static void Execute(
				...
				SqlInt32 deleted,
				SqlString note,
				ref SqlInt32 orderDetailId
				#endregion
		    )
		{
			ORDER_DETAILS_Insert oRDER_DETAILS_Insert = new ORDER_DETAILS_Insert();
			
			#region Assign Property Values
			oRDER_DETAILS_Insert.ConnectionString = connectionString;
			oRDER_DETAILS_Insert.OrderDetailId = orderDetailId;
			oRDER_DETAILS_Insert.OrderId = orderId;
			oRDER_DETAILS_Insert.ItemId = itemId;
			oRDER_DETAILS_Insert.Quantity = quantity;
			oRDER_DETAILS_Insert.IdPrice = idPrice;
			oRDER_DETAILS_Insert.CreateBy = createBy;
			oRDER_DETAILS_Insert.CreateDate = createDate;
			oRDER_DETAILS_Insert.ModifiedBy = modifiedBy;
			oRDER_DETAILS_Insert.ModifiedDate = modifiedDate;
			oRDER_DETAILS_Insert.Deleted = deleted;
			oRDER_DETAILS_Insert.Note = note;
			#endregion
			
			oRDER_DETAILS_Insert.Execute();
			
			#region Get Property Values
			orderDetailId = oRDER_DETAILS_Insert.OrderDetailId;
			#endregion
		}
		#endregion
	}
