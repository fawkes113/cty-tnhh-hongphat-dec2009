...
{
    public class OrderBuyDetailsController
    {
        public static ArrayList GetAll(SqlConnection conn)
        {
            string sqlCmd = "SELECT * FROM ORDER_BUY_DETAILS WHERE DELETED = 0";
            conn.Open();
            SqlCommand comm = new SqlCommand(sqlCmd, conn);
            return CBO.FillCollection(comm.ExecuteReader(), typeof(OrderBuyDetailsInfo));
        }
        public static ArrayList GetAllHaveOrderBy(SqlConnection conn, string OrderColumn, string OrderType)
        {
            string sqlCmd = "SELECT * FROM ORDER_BUY_DETAILS WHERE DELETED = 0 ORDER BY " + OrderColumn + " " + OrderType;
            SqlCommand comm = new SqlCommand(sqlCmd, conn);
            return CBO.FillCollection(comm.ExecuteReader(), typeof(OrderBuyDetailsInfo));
        }
        public static ArrayList GetByColumn(SqlConnection conn, string columnName, object columnValue)
        {
            ...
            if (columnValue == null)
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT * FROM ORDER_BUY_DETAILS WHERE " + sqlWhere + " AND DELETED = 0";
        ...
        public static ArrayList GetByColumnHaveOrderBy(SqlConnection conn, string columnName, object columnValue, string orderColumn, string orderType)
        {
            ...
            if (columnValue == null)
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT * FROM ORDER_BUY_DETAILS WHERE " + sqlWhere + " AND DELETED = 0" + " ORDER BY " + orderColumn + " " + orderType;

            conn.Open();
            SqlCommand comm = new SqlCommand(sqlCmd, conn);
            return CBO.FillCollection(comm.ExecuteReader(), typeof(OrderBuyDetailsInfo));
        }
        public static OrderBuyDetailsInfo GetByColumnTop1(SqlConnection conn, string columnName, object columnValue)
        {
            string sqlWhere = "";
            if (columnValue == null)
                sqlWhere = columnName + " IS NULL";
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT top 1 * FROM ORDER_BUY_DETAILS WHERE " + sqlWhere + " AND DELETED = 0";

            conn.Open();
            SqlCommand comm = new SqlCommand(sqlCmd, conn);
            return (OrderBuyDetailsInfo)CBO.FillObject(comm.ExecuteReader(), typeof(OrderBuyDetailsInfo));
        }
        public static OrderBuyDetailsInfo GetByColumnsTop1(SqlConnection conn, params object[] columns)
        {
        ...
        public static void DeleteByColumns(SqlConnection conn, params object[] columns)
        {
            ...
            string sqlCmd = "DELETE ORDER_BUY_DETAILS WHERE " + sqlWhere + " AND DELETED = 0";
        ...
        public static int Insert(SqlConnection conn, OrderBuyDetailsInfo objBO)
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("ORDER_BUY_DETAILS_Insert", conn);
        ...
        public static void Update(SqlConnection conn, OrderBuyDetailsInfo objBO)
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("ORDER_BUY_DETAILS_Update", conn);
            comm.CommandType = CommandType.StoredProcedure;
            SqlParameter param;

            param = new SqlParameter();
            param.ParameterName = "@OrderBuyDetailId";
            param.SqlDbType = SqlDbType.Int;
            param.Value = objBO.OrderBuyDetailId;
            param.Direction = ParameterDirection.Input;
            comm.Parameters.Add(param);
        ...
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("ORDER_BUY_DETAILS_Delete", conn);
            comm.CommandType = CommandType.StoredProcedure;
