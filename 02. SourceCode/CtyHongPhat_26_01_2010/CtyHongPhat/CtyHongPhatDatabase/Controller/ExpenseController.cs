...
namespace CtyHongPhatDatabase.Controller
{
    public class ExpenseController
    {
        ...
        {
            string sqlCmd = "SELECT * FROM EXPENSE WHERE DELETED = 0";
            conn.Open();
        ...
        {
            string sqlCmd = "SELECT * FROM EXPENSE WHERE DELETED = 0 ORDER BY " + OrderColumn + " " + OrderType;
            conn.Open();
            SqlCommand comm = new SqlCommand(sqlCmd, conn);
            return CBO.FillCollection(comm.ExecuteReader(), typeof(AgentKindInfo));
        }
        public static ArrayList GetByColumn(SqlConnection conn, string columnName, object columnValue)
        {
            ...
            if (columnValue == null)
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT * FROM EXPENSE WHERE " + sqlWhere + " AND DELETED = 0";
        ...
        public static ArrayList GetByColumnHaveOrderBy(SqlConnection conn, string columnName, object columnValue, string orderColumn, string orderType)
        {
            ...
            if (columnValue == null)
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT * FROM EXPENSE WHERE " + sqlWhere + " AND DELETED = 0" + " ORDER BY " + orderColumn + " " + orderType;
        ...
        public static AgentKindInfo GetByColumnTop1(SqlConnection conn, string columnName, object columnValue)
        {
            ...
            if (columnValue == null)
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT top 1 * FROM EXPENSE WHERE " + sqlWhere + " AND DELETED = 0";
        ...
        public static void DeleteByColumns(SqlConnection conn, params object[] columns)
        {
            ...
            string sqlCmd = "DELETE EXPENSE WHERE " + sqlWhere + " AND DELETED = 0";
        ...
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("EXPENSE_Insert", conn);
        ...
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("EXPENSE_Update", conn);
            comm.CommandType = CommandType.StoredProcedure;
        ...
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("EXPENSE_Delete", conn);
            comm.CommandType = CommandType.StoredProcedure;
