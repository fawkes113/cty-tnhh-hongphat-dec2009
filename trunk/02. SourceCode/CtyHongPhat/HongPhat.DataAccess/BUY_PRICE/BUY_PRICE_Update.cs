...
{
	#region BUY_PRICE_Update Wrapper
    /// <summary>
    /// This class is a wrapper for the BUY_PRICE_Update stored procedure.
    /// </summary>
    public class BUY_PRICE_Update
    {
		...
		#region Constructors
		public BUY_PRICE_Update()
		{
		}
		
		public BUY_PRICE_Update(string connectionString)
		{
		...
		/// <summary>
		/// The connection string to use when executing the BUY_PRICE_Update stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the return value from the BUY_PRICE_Update stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the number of rows changed, inserted, or deleted by execution of the BUY_PRICE_Update stored procedure.
		/// </summary>
		...
		/// <summary>
		/// This method calls the BUY_PRICE_Update stored procedure.
		/// </summary>
		public virtual void Execute()
		{
			...
			{
				cmd.Connection = cn;
				cmd.CommandText = "[dbo].[BUY_PRICE_Update]";
		...
		{
			BUY_PRICE_Update bUY_PRICE_Update = new BUY_PRICE_Update();
			
			#region Assign Property Values
			bUY_PRICE_Update.ConnectionString = connectionString;
			bUY_PRICE_Update.Id = id;
			bUY_PRICE_Update.ItemId = itemId;
			bUY_PRICE_Update.PartnerId = partnerId;
			bUY_PRICE_Update.BuyPrice = buyPrice;
			bUY_PRICE_Update.CreatedBy = createdBy;
			bUY_PRICE_Update.CreatedDate = createdDate;
			bUY_PRICE_Update.ModifiedBy = modifiedBy;
			bUY_PRICE_Update.ModifiedDate = modifiedDate;
			bUY_PRICE_Update.Deleted = deleted;
			#endregion
			
			bUY_PRICE_Update.Execute();
