...
{
	#region ITEMS_Update Wrapper
    /// <summary>
    /// This class is a wrapper for the ITEMS_Update stored procedure.
    /// </summary>
    public class ITEMS_Update
    {
		...
		public ITEMS_Update(string connectionString)
		{
		...
		/// <summary>
		/// The connection string to use when executing the ITEMS_Update stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the return value from the ITEMS_Update stored procedure.
		/// </summary>
		...
		/// <summary>
		/// Gets the number of rows changed, inserted, or deleted by execution of the ITEMS_Update stored procedure.
		/// </summary>
		...
		/// <summary>
		/// This method calls the ITEMS_Update stored procedure.
		/// </summary>
		...
		{
			ITEMS_Update iTEMS_Update = new ITEMS_Update();
			
			#region Assign Property Values
			iTEMS_Update.ConnectionString = connectionString;
			iTEMS_Update.ItemId = itemId;
			iTEMS_Update.ItemName = itemName;
			iTEMS_Update.CreatedBy = createdBy;
			iTEMS_Update.CreatedDate = createdDate;
			iTEMS_Update.ModifiedBy = modifiedBy;
			iTEMS_Update.ModifiedDate = modifiedDate;
			iTEMS_Update.Deleted = deleted;
			iTEMS_Update.TotalQuantity = totalQuantity;
			iTEMS_Update.Measurement = measurement;
			#endregion
