...
namespace CtyHongPhatDatabase.Controller
{
    public class BankInterestRateController
    {
        ...
        {
            string sqlCmd = "SELECT * FROM BANK_INTEREST_RATE WHERE DELETED = 0";
            conn.Open();
            SqlCommand comm = new SqlCommand(sqlCmd, conn);
            return CBO.FillCollection(comm.ExecuteReader(), typeof(BankInterestRateInfo));
        }
        public static ArrayList GetAllHaveOrderBy(SqlConnection conn, string OrderColumn, string OrderType)
        {
            string sqlCmd = "SELECT * FROM BANK_INTEREST_RATE WHERE DELETED = 0 ORDER BY " + OrderColumn + " " + OrderType;
            conn.Open();
            SqlCommand comm = new SqlCommand(sqlCmd, conn);
            return CBO.FillCollection(comm.ExecuteReader(), typeof(BankInterestRateInfo));
        }
        ...
        public static ArrayList GetByColumnHaveOrderBy(SqlConnection conn, string columnName, object columnValue, string orderColumn, string orderType)
        {
            ...
            if (columnValue == null)
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT * FROM BANK_INTEREST_RATE WHERE " + sqlWhere + " AND DELETED = 0" + " ORDER BY " + orderColumn + " " + orderType;

            conn.Open();
            SqlCommand comm = new SqlCommand(sqlCmd, conn);
            return CBO.FillCollection(comm.ExecuteReader(), typeof(BankInterestRateInfo));
        }
        public static BankInterestRateInfo GetByColumnTop1(SqlConnection conn, string columnName, object columnValue)
        {
            string sqlWhere = "";
            if (columnValue == null)
                sqlWhere = columnName + " IS NULL";
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT top 1 * FROM BANK_INTEREST_RATE WHERE " + sqlWhere + " AND DELETED = 0";

            conn.Open();
            SqlCommand comm = new SqlCommand(sqlCmd, conn);
            return (BankInterestRateInfo)CBO.FillObject(comm.ExecuteReader(), typeof(BankInterestRateInfo));
        }
        public static BankInterestRateInfo GetByColumnsTop1(SqlConnection conn, params object[] columns)
        {
        ...
        {
            if (columns == null || columns.Length <= 0)
                return BankInterestRateController.GetAll(conn);
            if (columns.Length % 2 != 0)
                return null;
            string sqlWhere = "";
            for (int i = 0; i < columns.Length; i += 2)
        ...
        public static void DeleteByColumns(SqlConnection conn, params object[] columns)
        {
            ...
            string sqlCmd = "DELETE BANK_INTEREST_RATE WHERE " + sqlWhere + " AND DELETED = 0";
        ...
        public static int Insert(SqlConnection conn, BankInterestRateInfo objBO)
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("BANK_INTEREST_RATE_Insert", conn);
            ...
            param = new SqlParameter();
            param.ParameterName = "@RateAmount";
            param.SqlDbType = SqlDbType.Decimal;
            param.Value = objBO.RateAmount;
            param.Direction = ParameterDirection.Input;
            comm.Parameters.Add(param);
        ...
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("BANK_INTEREST_RATE_Update", conn);
            comm.CommandType = CommandType.StoredProcedure;
            SqlParameter param;

            param = new SqlParameter();
            param.ParameterName = "@BankInterestRateId";
            param.SqlDbType = SqlDbType.Int;
            param.Value = objBO.BankInterestRateId;
            param.Direction = ParameterDirection.Input;
            comm.Parameters.Add(param);
        ...
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("BANK_INTEREST_RATE_Delete", conn);
            comm.CommandType = CommandType.StoredProcedure;
