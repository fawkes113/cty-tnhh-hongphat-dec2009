    ...
    public class PackController
    {
        ...
        public static ArrayList GetByColumn(SqlConnection conn, string columnName, object columnValue)
        {
            ...
            if (columnValue == null)
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT * FROM PACKS WHERE " + sqlWhere + " AND DELETED = 0";
        ...
        public static ArrayList GetByColumnHaveOrderBy(SqlConnection conn, string columnName, object columnValue, string orderColumn, string orderType)
        {
            ...
            if (columnValue == null)
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT * FROM PACKS WHERE " + sqlWhere + " AND DELETED = 0" + " ORDER BY " + orderColumn + " " + orderType;
        ...
        public static AgentKindInfo GetByColumnTop1(SqlConnection conn, string columnName, object columnValue)
        {
            ...
            if (columnValue == null)
                ...
                sqlWhere = columnName + " = " + columnValue;
            string sqlCmd = "SELECT top 1 * FROM PACKS WHERE " + sqlWhere + " AND DELETED = 0";
        ...
        public static void DeleteByColumns(SqlConnection conn, params object[] columns)
        {
            ...
            string sqlCmd = "DELETE PACKS WHERE " + sqlWhere + " AND DELETED = 0";
        ...
        public static int Insert(SqlConnection conn, PackInfo objBO)
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("PACKS_Insert", conn);
            comm.CommandType = CommandType.StoredProcedure;
            SqlParameter param;

            param = new SqlParameter();
            param.ParameterName = "@PackName";
            param.SqlDbType = SqlDbType.NVarChar;
            param.Value = objBO.PackName;
        ...
        {
            conn.Open();
            SqlCommand comm = new SqlCommand("PACKS_Update", conn);
            comm.CommandType = CommandType.StoredProcedure;
            SqlParameter param;
